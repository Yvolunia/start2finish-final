...
class Profiles extends Component {
  ...
  componentDidMount() {
    this.loadProfiles("5af639e1734d1d446079f75c"); //Remove hard coded profile//
  }
  ...
  handleProfileSubmit = event => {
    ...
    {
    API.updateProfile("5af639e1734d1d446079f75c", {
        
        //Remove hard code id//
        kidName: this.state.kidName,
        reward: this.state.reward
      })
        .then(res => this.loadProfiles("5af639e1734d1d446079f75c")) //Remove hard coded profile//
        .catch(err => console.log(err));
    }
  };
